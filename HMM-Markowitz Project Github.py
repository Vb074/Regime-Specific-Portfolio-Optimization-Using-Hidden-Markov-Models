...
market = pd.read_csv('/paste-path-to-AllWorld-ETF', parse_dates = True, index_col = 'Date', thousands=',')
...
meta = pd.read_csv('paste-path-to-Meta', index_col = 'Date', parse_dates=True, thousands=',')
btc = pd.read_csv('paste-path-to-BTC', index_col = 'Date', parse_dates=True, thousands=',')
asml = pd.read_csv('paste-path-to-ASML', index_col = 'Date', parse_dates=True, thousands=',')
etf = pd.read_csv('/paste-path-to-AllWorld-ETF', index_col = 'Date', parse_dates=True, thousands=',')
toyota = pd.read_csv('paste-path-to-Toyota', index_col = 'Date', parse_dates=True, thousands=',')
bond = pd.read_csv('paste-path-to-GovBond', index_col = 'Date', parse_dates=True, thousands=',')
